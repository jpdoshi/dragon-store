    ...
    <ScreenView>
      ...
      >
        ...
        >
          ...
          {showAPIError && (
            <View>
              <Text className="mt-10 text-emerald-500 text-center font-medium leading-normal">
                Sign in with Github to extend Github API usage limit from 60 to
                5000 per hour.
              </Text>
              <TouchableOpacity className="h-[40px] flex-row justify-center items-center gap-1 shadow bg-dark-tertiary rounded-full mt-4">
                <View className="size-6">
                  <Svg viewBox="0 0 128 128">
                    <G fill="#000">
                      <Path
